        ...
        let arr:any[] = [`Clone`, 11, true, {}, 12, undefined, [], NaN, null, 55555,];
console.log(arr[0]);
console.log(arr[1]);
console.log(arr[2]);
console.log(arr[3]);
...
let book1:BookType = {title: `Hamlet`, pageCount: 790, genre: `Tragedy`}
let book2:BookType = {title: `Sherlok`, pageCount: 820, genre: `Detective`}
let book3:BookType = {title: `Hero`, pageCount: 210, genre: `Fantasy`}
console.log(book1);
console.log(book2);
console.log(book3);


type BookAuthorsType={
    name: string,
    age: number,
}
