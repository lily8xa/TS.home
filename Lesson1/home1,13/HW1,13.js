...
const usersFiltered = users13.filter(user => user.id % 2 === 0);
console.log(usersFiltered);
// – Взяти масив з  User[] з попереднього завдання, та відсортувати його по id. по зростанню (sort)
let userSorted = users13.sort((a, b) => a.id - b.id);
console.log(userSorted);
//  – створити конструктор для об’єктів Client з полями id, name, surname , email, phone, order (поле є масивом зі списком товарів)
//
// створити пустий масив, наповнити його 10 об’єктами Client
class Product {
    constructor(id, name, prise, Quantity) {
        this.id = id;
        this.name = name;
        this.prise = prise;
...
// }
let clients = [
    new Client(1, 'Olga', 'King', 'OlGa@taka.com', '+30665285475', [new Product(1, 'Mask', 552, 3), new Product(2, 'Towel', 85, 5)]),
    new Client(2, 'Yriy', 'Xrush', 'Xrust@hom.com', '+30695245685', [new Product(1, 'Olio', 25, 10), new Product(2, 'Pillow', 320, 2), new Product(3, 'Soup', 12, 6)]),
