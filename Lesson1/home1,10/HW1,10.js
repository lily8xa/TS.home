...
//
let RoundSquare1 = (radius) => Math.PI * radius * radius;
console.log(RoundSquare1(23));
// #Mbiz5K4yFe7
//
// – створити функцію, яка обчислює та повертає площу циліндру висотою h, та радіусом r
let CelinderSquare1 = (height, rud) => 2 * Math.PI * rud * height;
...
//
// #hOL6126
let addPage1 = (page) => { (document.write((`<p>${page}</p>`))); };
addPage1(`Hello`);
//
